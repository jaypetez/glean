...
This section is being filled out. For now, start with [What is a feed?](./feed.md), the [Architecture](./architecture.md) overview, and the [feeds.yaml reference](../config/feeds.md).
...
- Each **feed detail** page groups **Overview**, **Digests**, **Runs**, and **Edit** into one place.
